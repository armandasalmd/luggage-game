const TermsBase = () => {
  return (
    <>
      ...
      <div style={{marginTop: 16}}>Last Revised: 2021-12-20 00:43:08</div>
      <div>
        <h3>
          1. OVERVIEW
        </h3>
        <div>
          ...
          into by and between Luggage Game, registered address 51 Grafton
          Street, United Kingdom (&quot;Company&quot;) and you, and is made
          effective as of the date of your use of this website
          https://luggage-game.vercel.app (&quot;Site&quot;) or the date of
          electronic acceptance.
        </div>
        <div>
          This Agreement sets forth the general terms and conditions of your use
          of the https://luggage-game.vercel.app as well as the products and/or
          ...
          uses the Services. Nothing in this Agreement shall be deemed to confer
      ...
      <div>
        ...
        <div>
          ...
          the laws of the United Kingdom or other applicable jurisdiction.
        </div>
        <div>
      ...
      <div>
        ...
        <div>
          ...
          logos contained therein (&quot;Companies Content&quot;), are owned by
          or licensed to Luggage Game in perpetuity, and are subject to
      ...
      <div>
        ...
        <div>
          ...
          Kingdom, West Midlands, to the exclusion of conflict of law rules.
        </div>
      </div>
      <div>
        <h3>
        ...
        <div>
          ...
          other party. The arbitration must be conducted in United Kingdom, West
          Midlands, and judgment on the arbitration award may be entered into
      ...
      <div>
        ...
        <div>Luggage Game</div>
        <div>51 Grafton Street</div>
        <div>United Kingdom</div>
        <div>armandas.bark3@gmail.com</div>
      </div>
    </>
  );
};
